...
def seed_database(db: Session) -> None:
    ...
    # --- Real endpoint: this machine ---
    dev_machine = Endpoint(
        id=str(uuid.uuid4()),
        name="Dev Machine",
        ip_address="10.51.250.124",
        status="active",
        created_at=now,
    )
    db.add(dev_machine)
    ...
    db.commit()
    print("Database seeded: Dev Machine (10.51.250.124) + 8 starter policies. Alerts and predictions will be generated by the ML engine.")
